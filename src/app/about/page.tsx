...
export default function About() {
  ...
  <div className="flex flex-wrap gap-4 sm:gap-6 mb-6">
          ...
          <a href="/media/MohitEDIResume.pdf" className="bg-black text-white px-6 py-3 rounded font-bold text-lg shadow hover:bg-blue-800 transition" target="_blank" rel="noopener noreferrer">VIEW RESUME</a>
        </div>
  ...
  <div className="mb-4 w-full">
          ...
          <p className="text-gray-700 text-sm sm:text-base">I built a gaming startup from made it profitable in 11 months <a href="https://media.licdn.com/dms/image/v2/C4E22AQGOT9hYp_KDOQ/feedshare-shrink_2048_1536/feedshare-shrink_2048_1536/0/1622310291141?e=1758153600&v=beta&t=xkCaKpU0bqQMYk5uQ98QSydvN4O5CmOjXTEqGdrcXR0" className="text-blue-600 underline">our startup story</a></p>
